...
INSERT INTO db_dict.english VALUES (NULL, 'apple');
INSERT INTO db_dict.english VALUES (NULL, 'biffin');

INSERT INTO db_dict.english_chinese VALUES (1, 1);

INSERT INTO db_dict.english_chinese VALUES (2, 1);
...
SELECT e.word
FROM db_dict.
    english e INNER JOIN db_dict.chinese c
  INNER JOIN db_dict.english_chinese ec
    ON e.id = ec.englishId AND c.id = ec.chineseId
